...
tag @a[tag=leave_bwcastle] remove leave_bwcastle
...
execute unless score bwcastle bwState matches 0 if score bwcastle bwPlyrCnt matches 0 run function bedwars:bwcastle/victory/victory
