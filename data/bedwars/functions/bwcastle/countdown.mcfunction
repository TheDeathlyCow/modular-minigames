...
execute if score bwcastle bwCntDwn matches 20 run tellraw @a[tag=playing_bwcastle] [{"text":"The game will start in ","color":"aqua"},{"text":"1","color":"dark_purple"},{"text":" seconds!"}]
