...
execute if score splftower splfPlyrCnt matches 2.. if entity @a[tag=playing_splftower,scores={start_spleef=1..}] if score splftower startVoteCntr = splftower splfPlyrCnt if score splftower spleefCountdown matches ..-1 positioned -799 25 -236 run function spleef:splftower/countdown/initiate
