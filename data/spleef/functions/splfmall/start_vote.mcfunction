...
execute if score splfmall splfPlyrCnt matches 2.. if entity @a[tag=playing_splfmall,scores={start_spleef=1..}] if score splfmall startVoteCntr = splfmall splfPlyrCnt if score splfmall spleefCountdown matches ..-1 positioned -847 31 -512 run function spleef:splfmall/countdown/initiate
