...
execute if score splfmall splfPlyrCnt matches 1.. if entity @a[tag=playing_splfmall,scores={start_spleef=1..}] if score splfmall startVoteCntr = splfmall splfPlyrCnt if score splfmall spleefCountdown matches ..-1 positioned -820 91 1260 run function spleef:splfmall/countdown/initiate
