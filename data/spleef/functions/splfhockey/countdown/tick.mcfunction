...
execute if score splfhockey spleefCountdown matches 300 run title @a[tag=playing_splfhockey] title {"text":"15","color":"dark_purple"}
...
execute if score splfhockey spleefCountdown matches 200 run title @a[tag=playing_splfhockey] title {"text":"10","color":"dark_purple"}
...
execute if score splfhockey spleefCountdown matches 100 run title @a[tag=playing_splfhockey] title {"text":"5","color":"dark_purple"}
...
execute if score splfhockey spleefCountdown matches 80 run title @a[tag=playing_splfhockey] title {"text":"4","color":"dark_purple"}
...
execute if score splfhockey spleefCountdown matches 60 run title @a[tag=playing_splfhockey] title {"text":"3","color":"dark_purple"}
...
execute if score splfhockey spleefCountdown matches 40 run title @a[tag=playing_splfhockey] title {"text":"2","color":"dark_purple"}
...
execute if score splfhockey spleefCountdown matches 20 run title @a[tag=playing_splfhockey] title {"text":"1","color":"dark_purple"}
