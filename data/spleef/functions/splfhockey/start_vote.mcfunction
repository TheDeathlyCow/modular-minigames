...
execute if score splfhockey splfPlyrCnt matches 2.. if entity @a[tag=playing_splfhockey,scores={start_spleef=1..}] if score splfhockey startVoteCntr = splfhockey splfPlyrCnt if score splfhockey spleefCountdown matches ..-1 positioned 1122 94 -471 run function spleef:splfhockey/countdown/initiate
